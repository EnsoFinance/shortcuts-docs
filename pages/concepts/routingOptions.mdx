...
## Enso Wallet
`ensowallet`: returns calldata for deploying an Enso smart account, and executing all the logic inside of the smart account in the same transaction.  Possible for [tokenized](./tokenized-nontokenized/tokenized.mdx) and [non-tokenized](./tokenized-nontokenized/nontokenized.mdx).
