...
In DeFi trading, it's common to encounter variable losses due to [price impact](https://support.uniswap.org/hc/en-us/articles/8671539602317-What-is-Price-Impact-). The Enso Router works hard to find the best route for your trade. If your position and its underlyings are supported, it will use the position directly. Otherwise, it looks for the best AMM to route the trade through.
